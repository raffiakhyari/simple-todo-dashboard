      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="rounded-xl bg-white shadow-sm">
          <div className="flex items-center justify-between border-b border-slate-200 px-6 py-4">
            <h2 className="font-semibold text-slate-900">Todo List</h2>
          ...
          {loading ? (
            <div className="p-6 text-slate-500">Loading todos...</div>
          ) : todos.length === 0 ? (
            <div className="p-10 text-center text-slate-500">No todos yet.</div>
          ) : (
